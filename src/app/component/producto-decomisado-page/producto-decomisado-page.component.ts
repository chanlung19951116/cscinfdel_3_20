...
@Component({
  selector: 'app-producto-decomisado-page',
  templateUrl: './producto-decomisado-page.component.html',
  styleUrls: ['./producto-decomisado-page.component.scss']
})
export class ProductoDecomisadoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ProductoDecomisadoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ProductoDecomisadoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.productoDecomisado.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.productoDecomisado.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.productoDecomisado.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ProductoDecomisadoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.productoDecomisado
      .getByPageAndFilter({
