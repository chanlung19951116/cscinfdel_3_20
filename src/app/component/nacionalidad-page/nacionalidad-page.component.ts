...
@Component({
  selector: 'app-nacionalidad-page',
  templateUrl: './nacionalidad-page.component.html',
  styleUrls: ['./nacionalidad-page.component.scss']
})
export class NacionalidadPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: NacionalidadDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new NacionalidadDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.nacionalidad.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.nacionalidad.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.nacionalidad.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class NacionalidadDataSource implements DataSource<any> {
