...
@Component({
  selector: 'app-parte-robada-vehiculo-page',
  templateUrl: './parte-robada-vehiculo-page.component.html',
  styleUrls: ['./parte-robada-vehiculo-page.component.scss']
})
export class ParteRobadaVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ParteRobadaVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ParteRobadaVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.parteRobadaVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.parteRobadaVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.parteRobadaVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ParteRobadaVehiculoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.parteRobadaVehiculo
      .getByPageAndFilter({
