...
@Component({
  selector: 'app-etnia-page',
  templateUrl: './etnia-page.component.html',
  styleUrls: ['./etnia-page.component.scss']
})
export class EtniaPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new EtniaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.etnia.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.etnia.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.etnia.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class EtniaDataSource implements DataSource<any> {
