...
@Component({
  selector: 'app-grupo-focales-page',
  templateUrl: './grupo-focales-page.component.html',
  styleUrls: ['./grupo-focales-page.component.scss']
})
export class GrupoFocalesPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: GrupoFocalesDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new GrupoFocalesDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.grupoFocales.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.grupoFocales.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.grupoFocales.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class GrupoFocalesDataSource implements DataSource<any> {
