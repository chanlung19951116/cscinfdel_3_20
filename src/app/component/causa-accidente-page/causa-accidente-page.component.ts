...
@Component({
  selector: 'app-causa-accidente-page',
  templateUrl: './causa-accidente-page.component.html',
  styleUrls: ['./causa-accidente-page.component.scss']
})
export class CausaAccidentePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: CausaAccidenteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new CausaAccidenteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.causaAccidente.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.causaAccidente.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.causaAccidente.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class CausaAccidenteDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.causaAccidente
      .getByPageAndFilter({
