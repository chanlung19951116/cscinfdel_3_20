...
@Component({
  selector: 'app-am-tipo-amenaza-page',
  templateUrl: './am-tipo-amenaza-page.component.html',
  styleUrls: ['./am-tipo-amenaza-page.component.scss']
})
export class AmTipoAmenazaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AmTipoAmenazaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AmTipoAmenazaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.amTipoAmenaza.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.amTipoAmenaza.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.amTipoAmenaza.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AmTipoAmenazaDataSource implements DataSource<any> {
