...
@Component({
  selector: 'app-autor-delito-page',
  templateUrl: './autor-delito-page.component.html',
  styleUrls: ['./autor-delito-page.component.scss']
})
export class AutorDelitoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AutorDelitoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AutorDelitoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.autorDelito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.autorDelito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.autorDelito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AutorDelitoDataSource implements DataSource<any> {
