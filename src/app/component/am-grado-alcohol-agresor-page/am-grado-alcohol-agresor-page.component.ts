...
@Component({
  selector: 'app-am-grado-alcohol-agresor-page',
  templateUrl: './am-grado-alcohol-agresor-page.component.html',
  styleUrls: ['./am-grado-alcohol-agresor-page.component.scss']
})
export class AmGradoAlcoholAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AmGradoAlcoholAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AmGradoAlcoholAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.amGradoAlcoholAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.amGradoAlcoholAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.amGradoAlcoholAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AmGradoAlcoholAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.amGradoAlcoholAgresor
      .getByPageAndFilter({
