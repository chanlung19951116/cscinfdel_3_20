...
@Component({
  selector: 'app-color-vehiculo-page',
  templateUrl: './color-vehiculo-page.component.html',
  styleUrls: ['./color-vehiculo-page.component.scss']
})
export class ColorVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ColorVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ColorVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.colorVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.colorVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.colorVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ColorVehiculoDataSource implements DataSource<any> {
