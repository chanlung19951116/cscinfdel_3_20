...
@Component({
  selector: 'app-afectado-page',
  templateUrl: './afectado-page.component.html',
  styleUrls: ['./afectado-page.component.scss']
})
export class AfectadoPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new AfectadoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.afectado.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.afectado.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.afectado.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AfectadoDataSource implements DataSource<any> {
