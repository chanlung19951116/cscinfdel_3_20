...
@Component({
  selector: 'app-tipo-via-page',
  templateUrl: './tipo-via-page.component.html',
  styleUrls: ['./tipo-via-page.component.scss']
})
export class TipoViaPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoViaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoVia.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoVia.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoVia.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoViaDataSource implements DataSource<any> {
