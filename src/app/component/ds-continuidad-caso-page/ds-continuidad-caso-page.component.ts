...
@Component({
  selector: 'app-ds-continuidad-caso-page',
  templateUrl: './ds-continuidad-caso-page.component.html',
  styleUrls: ['./ds-continuidad-caso-page.component.scss']
})
export class DsContinuidadCasoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: DsContinuidadCasoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new DsContinuidadCasoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.dsContinuidadCaso.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.dsContinuidadCaso.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.dsContinuidadCaso.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class DsContinuidadCasoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.dsContinuidadCaso
      .getByPageAndFilter({
