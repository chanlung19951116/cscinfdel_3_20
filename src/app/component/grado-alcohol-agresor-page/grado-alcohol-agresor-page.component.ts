...
@Component({
  selector: 'app-grado-alcohol-agresor-page',
  templateUrl: './grado-alcohol-agresor-page.component.html',
  styleUrls: ['./grado-alcohol-agresor-page.component.scss']
})
export class GradoAlcoholAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: GradoAlcoholAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new GradoAlcoholAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.gradoAlcoholAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.gradoAlcoholAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.gradoAlcoholAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class GradoAlcoholAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.gradoAlcoholAgresor
      .getByPageAndFilter({
