...
@Component({
  selector: 'app-sexo-page',
  templateUrl: './sexo-page.component.html',
  styleUrls: ['./sexo-page.component.scss']
})
export class SexoPageComponent implements OnInit, AfterViewInit {
