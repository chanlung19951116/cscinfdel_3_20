...
@Component({
  selector: 'app-alcohol-victima-page',
  templateUrl: './alcohol-victima-page.component.html',
  styleUrls: ['./alcohol-victima-page.component.scss']
})
export class AlcoholVictimaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AlcoholVictimaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AlcoholVictimaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.alcoholVictima.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.alcoholVictima.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.alcoholVictima.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AlcoholVictimaDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.alcoholVictima
      .getByPageAndFilter({
