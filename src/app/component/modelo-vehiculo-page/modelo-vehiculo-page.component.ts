...
@Component({
  selector: 'app-modelo-vehiculo-page',
  templateUrl: './modelo-vehiculo-page.component.html',
  styleUrls: ['./modelo-vehiculo-page.component.scss']
})
export class ModeloVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ModeloVehiculoDataSource;
  ...
  ngOnInit() {
    this.dataSource = new ModeloVehiculoDataSource(this.apiService, this.spinner);
  ...
  initForms() {
    ...
    const controlsConfig = {
      ...
      marcaModeloVehiculo: [null, Validators.compose([Validators.required])],
    };
  ...
  create() {
    ...
    this.spinner.show();
    this.apiService.modeloVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  startEditing(row) {
    ...
    this.loadRelatedData(() => {
      ...
      this.editForm.patchValue({
        ...
        marcaModeloVehiculo: this.selectedItem.marcaModeloVehiculo,
      });
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.modeloVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.modeloVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
  ...
  public loadRelatedData(finishedCallback) {
    ...
    this.apiService.pageData.modeloVehiculo().subscribe(
      (response: any) => {
        this.spinner.hide();
...
class ModeloVehiculoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.modeloVehiculo
      .getByPageAndFilter({
