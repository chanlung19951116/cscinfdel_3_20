...
@Component({
  selector: 'app-tipo-amenaza-page',
  templateUrl: './tipo-amenaza-page.component.html',
  styleUrls: ['./tipo-amenaza-page.component.scss']
})
export class TipoAmenazaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoAmenazaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoAmenazaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoAmenaza.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoAmenaza.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoAmenaza.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoAmenazaDataSource implements DataSource<any> {
