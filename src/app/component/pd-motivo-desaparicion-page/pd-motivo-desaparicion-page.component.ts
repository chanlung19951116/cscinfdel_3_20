...
@Component({
  selector: 'app-pd-motivo-desaparicion-page',
  templateUrl: './pd-motivo-desaparicion-page.component.html',
  styleUrls: ['./pd-motivo-desaparicion-page.component.scss']
})
export class PdMotivoDesaparicionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: PdMotivoDesaparicionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new PdMotivoDesaparicionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.pdMotivoDesaparicion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.pdMotivoDesaparicion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.pdMotivoDesaparicion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class PdMotivoDesaparicionDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.pdMotivoDesaparicion
      .getByPageAndFilter({
