...
@Component({
  selector: 'app-lugar-page',
  templateUrl: './lugar-page.component.html',
  styleUrls: ['./lugar-page.component.scss']
})
export class LugarPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new LugarDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.lugar.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.lugar.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.lugar.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class LugarDataSource implements DataSource<any> {
