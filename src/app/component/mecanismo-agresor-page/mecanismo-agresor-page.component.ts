...
@Component({
  selector: 'app-mecanismo-agresor-page',
  templateUrl: './mecanismo-agresor-page.component.html',
  styleUrls: ['./mecanismo-agresor-page.component.scss']
})
export class MecanismoAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: MecanismoAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new MecanismoAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.mecanismoAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.mecanismoAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.mecanismoAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class MecanismoAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.mecanismoAgresor
      .getByPageAndFilter({
