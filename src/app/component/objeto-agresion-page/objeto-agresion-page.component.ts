...
@Component({
  selector: 'app-objeto-agresion-page',
  templateUrl: './objeto-agresion-page.component.html',
  styleUrls: ['./objeto-agresion-page.component.scss']
})
export class ObjetoAgresionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ObjetoAgresionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ObjetoAgresionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.objetoAgresion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.objetoAgresion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.objetoAgresion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ObjetoAgresionDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.objetoAgresion
      .getByPageAndFilter({
