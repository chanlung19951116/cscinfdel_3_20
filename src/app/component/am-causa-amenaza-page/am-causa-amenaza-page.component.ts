...
@Component({
  selector: 'app-am-causa-amenaza-page',
  templateUrl: './am-causa-amenaza-page.component.html',
  styleUrls: ['./am-causa-amenaza-page.component.scss']
})
export class AmCausaAmenazaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AmCausaAmenazaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AmCausaAmenazaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.amCausaAmenaza.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.amCausaAmenaza.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.amCausaAmenaza.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AmCausaAmenazaDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.amCausaAmenaza
      .getByPageAndFilter({
