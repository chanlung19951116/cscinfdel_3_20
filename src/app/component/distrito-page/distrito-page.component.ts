...
@Component({
  selector: 'app-distrito-page',
  templateUrl: './distrito-page.component.html',
  styleUrls: ['./distrito-page.component.scss']
})
export class DistritoPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new DistritoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.distrito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.distrito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.distrito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class DistritoDataSource implements DataSource<any> {
