...
@Component({
  selector: 'app-momento-accidente-page',
  templateUrl: './momento-accidente-page.component.html',
  styleUrls: ['./momento-accidente-page.component.scss']
})
export class MomentoAccidentePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: MomentoAccidenteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new MomentoAccidenteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.momentoAccidente.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.momentoAccidente.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.momentoAccidente.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class MomentoAccidenteDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.momentoAccidente
      .getByPageAndFilter({
