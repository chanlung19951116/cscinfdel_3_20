...
@Component({
  selector: 'app-marca-vehiculo-page',
  templateUrl: './marca-vehiculo-page.component.html',
  styleUrls: ['./marca-vehiculo-page.component.scss']
})
export class MarcaVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: MarcaVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new MarcaVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.marcaVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.marcaVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.marcaVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class MarcaVehiculoDataSource implements DataSource<any> {
