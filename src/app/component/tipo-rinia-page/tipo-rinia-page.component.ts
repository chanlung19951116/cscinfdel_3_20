...
@Component({
  selector: 'app-tipo-rinia-page',
  templateUrl: './tipo-rinia-page.component.html',
  styleUrls: ['./tipo-rinia-page.component.scss']
})
export class TipoRiniaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoRiniaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoRiniaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoRinia.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoRinia.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoRinia.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoRiniaDataSource implements DataSource<any> {
