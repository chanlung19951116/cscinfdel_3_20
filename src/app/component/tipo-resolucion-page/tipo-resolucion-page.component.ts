...
@Component({
  selector: 'app-tipo-resolucion-page',
  templateUrl: './tipo-resolucion-page.component.html',
  styleUrls: ['./tipo-resolucion-page.component.scss']
})
export class TipoResolucionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoResolucionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoResolucionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoResolucion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoResolucion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoResolucion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoResolucionDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.tipoResolucion
      .getByPageAndFilter({
