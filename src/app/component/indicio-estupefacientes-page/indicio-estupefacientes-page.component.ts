...
@Component({
  selector: 'app-indicio-estupefacientes-page',
  templateUrl: './indicio-estupefacientes-page.component.html',
  styleUrls: ['./indicio-estupefacientes-page.component.scss']
})
export class IndicioEstupefacientesPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: IndicioEstupefacientesDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new IndicioEstupefacientesDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.indicioEstupefacientes.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.indicioEstupefacientes.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.indicioEstupefacientes.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class IndicioEstupefacientesDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.indicioEstupefacientes
      .getByPageAndFilter({
