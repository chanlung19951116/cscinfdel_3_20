...
export class RolPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new RolDataSource(this.apiService, this.spinner);
  ...
  initForms() {
    ...
    this.createForm = this.fb.group({
      rolDescripcion: [null, Validators.compose([Validators.required])],
      rolEstado: [null, Validators.compose([Validators.required])],
    });
  ...
  create() {
    ...
    this.apiService.rol.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  startEditing(row) {
    ...
    this.editForm.patchValue({
      rolDescripcion: this.selectedItem.rolDescripcion,
      rolEstado: this.selectedItem.rolEstado,
    });
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.rol.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.rol.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class RolDataSource implements DataSource<any> {
