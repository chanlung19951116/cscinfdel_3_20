...
@Component({
  selector: 'app-estado-civil-page',
  templateUrl: './estado-civil-page.component.html',
  styleUrls: ['./estado-civil-page.component.scss']
})
export class EstadoCivilPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new EstadoCivilDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.estadoCivil.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.estadoCivil.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.estadoCivil.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class EstadoCivilDataSource implements DataSource<any> {
