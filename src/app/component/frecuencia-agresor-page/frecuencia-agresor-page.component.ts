...
@Component({
  selector: 'app-frecuencia-agresor-page',
  templateUrl: './frecuencia-agresor-page.component.html',
  styleUrls: ['./frecuencia-agresor-page.component.scss']
})
export class FrecuenciaAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: FrecuenciaAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new FrecuenciaAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.frecuenciaAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.frecuenciaAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.frecuenciaAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class FrecuenciaAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.frecuenciaAgresor
      .getByPageAndFilter({
