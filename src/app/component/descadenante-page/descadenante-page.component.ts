...
@Component({
  selector: 'app-descadenante-page',
  templateUrl: './descadenante-page.component.html',
  styleUrls: ['./descadenante-page.component.scss']
})
export class DescadenantePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: DescadenanteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new DescadenanteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.descadenante.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.descadenante.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.descadenante.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class DescadenanteDataSource implements DataSource<any> {
