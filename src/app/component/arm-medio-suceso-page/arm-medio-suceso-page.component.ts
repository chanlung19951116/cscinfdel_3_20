...
@Component({
  selector: 'app-arm-medio-suceso-page',
  templateUrl: './arm-medio-suceso-page.component.html',
  styleUrls: ['./arm-medio-suceso-page.component.scss']
})
export class ArmMedioSucesoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ArmMedioSucesoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ArmMedioSucesoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.armMedioSuceso.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.armMedioSuceso.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.armMedioSuceso.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ArmMedioSucesoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.armMedioSuceso
      .getByPageAndFilter({
