...
@Component({
  selector: 'app-parentezco-persona-page',
  templateUrl: './parentezco-persona-page.component.html',
  styleUrls: ['./parentezco-persona-page.component.scss']
})
export class ParentezcoPersonaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ParentezcoPersonaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ParentezcoPersonaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.parentezcoPersona.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.parentezcoPersona.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.parentezcoPersona.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ParentezcoPersonaDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.parentezcoPersona
      .getByPageAndFilter({
