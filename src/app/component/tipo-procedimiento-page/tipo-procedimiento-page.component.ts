...
@Component({
  selector: 'app-tipo-procedimiento-page',
  templateUrl: './tipo-procedimiento-page.component.html',
  styleUrls: ['./tipo-procedimiento-page.component.scss']
})
export class TipoProcedimientoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoProcedimientoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoProcedimientoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoProcedimiento.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoProcedimiento.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoProcedimiento.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoProcedimientoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.tipoProcedimiento
      .getByPageAndFilter({
