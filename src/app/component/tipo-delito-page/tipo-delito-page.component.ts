...
@Component({
  selector: 'app-tipo-delito-page',
  templateUrl: './tipo-delito-page.component.html',
  styleUrls: ['./tipo-delito-page.component.scss']
})
export class TipoDelitoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoDelitoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoDelitoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoDelito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoDelito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoDelito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoDelitoDataSource implements DataSource<any> {
