...
@Component({
  selector: 'app-relacion-agresor-page',
  templateUrl: './relacion-agresor-page.component.html',
  styleUrls: ['./relacion-agresor-page.component.scss']
})
export class RelacionAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: RelacionAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new RelacionAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.relacionAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.relacionAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.relacionAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class RelacionAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.relacionAgresor
      .getByPageAndFilter({
