...
@Component({
  selector: 'app-tipo-agresion-page',
  templateUrl: './tipo-agresion-page.component.html',
  styleUrls: ['./tipo-agresion-page.component.scss']
})
export class TipoAgresionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoAgresionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoAgresionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoAgresion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoAgresion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoAgresion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoAgresionDataSource implements DataSource<any> {
