...
@Component({
  selector: 'app-circuito-page',
  templateUrl: './circuito-page.component.html',
  styleUrls: ['./circuito-page.component.scss']
})
export class CircuitoPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new CircuitoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.circuito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.circuito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.circuito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class CircuitoDataSource implements DataSource<any> {
