...
@Component({
  selector: 'app-rango-lesion-page',
  templateUrl: './rango-lesion-page.component.html',
  styleUrls: ['./rango-lesion-page.component.scss']
})
export class RangoLesionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: RangoLesionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new RangoLesionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.rangoLesion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.rangoLesion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.rangoLesion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class RangoLesionDataSource implements DataSource<any> {
