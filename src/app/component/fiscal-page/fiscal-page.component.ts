...
@Component({
  ...
  styleUrls: ['./fiscal-page.component.scss']
})
export class FiscalPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new FiscalDataSource(this.apiService, this.spinner);
  ...
  initForms() {
    ...
    const controlsConfig = {
      fiscalNombre: [null, Validators.compose([Validators.required])],
      fiscalTelefono: [null, Validators.compose([Validators.required])],
      fiscalEstado: [null, Validators.compose([Validators.required])],
  ...
  create() {
    ...
    this.apiService.fiscal.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  startEditing(row) {
    ...
    this.editForm.patchValue({
      fiscalNombre: this.selectedItem.fiscalNombre,
      fiscalTelefono: this.selectedItem.fiscalTelefono,
      fiscalEstado: this.selectedItem.fiscalEstado,
  ...
  save() {
    ...
    params.fiscalCodigo = this.selectedItem.fiscalCodigo;


    this.spinner.show();
    this.apiService.fiscal.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.fiscal.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class FiscalDataSource implements DataSource<any> {
