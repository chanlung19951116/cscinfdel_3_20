...
@Component({
  selector: 'app-tipo-empresa-vehiculo-page',
  templateUrl: './tipo-empresa-vehiculo-page.component.html',
  styleUrls: ['./tipo-empresa-vehiculo-page.component.scss']
})
export class TipoEmpresaVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoEmpresaVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoEmpresaVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoEmpresaVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoEmpresaVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoEmpresaVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoEmpresaVehiculoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.tipoEmpresaVehiculo
      .getByPageAndFilter({
