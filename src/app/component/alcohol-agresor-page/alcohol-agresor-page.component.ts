...
@Component({
  selector: 'app-alcohol-agresor-page',
  templateUrl: './alcohol-agresor-page.component.html',
  styleUrls: ['./alcohol-agresor-page.component.scss']
})
export class AlcoholAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AlcoholAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AlcoholAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.alcoholAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.alcoholAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.alcoholAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AlcoholAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.alcoholAgresor
      .getByPageAndFilter({
