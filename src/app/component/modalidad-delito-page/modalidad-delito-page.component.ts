...
@Component({
  selector: 'app-modalidad-delito-page',
  templateUrl: './modalidad-delito-page.component.html',
  styleUrls: ['./modalidad-delito-page.component.scss']
})
export class ModalidadDelitoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ModalidadDelitoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ModalidadDelitoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.modalidadDelito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.modalidadDelito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.modalidadDelito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ModalidadDelitoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.modalidadDelito
      .getByPageAndFilter({
