...
@Component({
  selector: 'app-clase-accidente-page',
  templateUrl: './clase-accidente-page.component.html',
  styleUrls: ['./clase-accidente-page.component.scss']
})
export class ClaseAccidentePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ClaseAccidenteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ClaseAccidenteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.claseAccidente.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.claseAccidente.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.claseAccidente.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ClaseAccidenteDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.claseAccidente
      .getByPageAndFilter({
