...
@Component({
  selector: 'app-motivo-muerte-page',
  templateUrl: './motivo-muerte-page.component.html',
  styleUrls: ['./motivo-muerte-page.component.scss']
})
export class MotivoMuertePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: MotivoMuerteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new MotivoMuerteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.motivoMuerte.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.motivoMuerte.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.motivoMuerte.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class MotivoMuerteDataSource implements DataSource<any> {
