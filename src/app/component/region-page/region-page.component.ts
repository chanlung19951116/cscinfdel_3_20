...
export class RegionPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new RegionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.region.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.region.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.region.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class RegionDataSource implements DataSource<any> {
