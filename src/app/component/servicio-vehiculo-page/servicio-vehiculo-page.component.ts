...
@Component({
  selector: 'app-servicio-vehiculo-page',
  templateUrl: './servicio-vehiculo-page.component.html',
  styleUrls: ['./servicio-vehiculo-page.component.scss']
})
export class ServicioVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ServicioVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ServicioVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.servicioVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.servicioVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.servicioVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ServicioVehiculoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.servicioVehiculo
      .getByPageAndFilter({
