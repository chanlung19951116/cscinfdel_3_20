...
@Component({
  selector: 'app-parroquia-desaparicion-page',
  templateUrl: './parroquia-desaparicion-page.component.html',
  styleUrls: ['./parroquia-desaparicion-page.component.scss']
})
export class ParroquiaDesaparicionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ParroquiaDesaparicionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ParroquiaDesaparicionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.parroquiaDesaparicion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.parroquiaDesaparicion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.parroquiaDesaparicion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ParroquiaDesaparicionDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.parroquiaDesaparicion
      .getByPageAndFilter({
