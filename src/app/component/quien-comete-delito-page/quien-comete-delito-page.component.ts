...
@Component({
  selector: 'app-quien-comete-delito-page',
  templateUrl: './quien-comete-delito-page.component.html',
  styleUrls: ['./quien-comete-delito-page.component.scss']
})
export class QuienCometeDelitoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: QuienCometeDelitoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new QuienCometeDelitoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.quienCometeDelito.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.quienCometeDelito.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.quienCometeDelito.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class QuienCometeDelitoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.quienCometeDelito
      .getByPageAndFilter({
