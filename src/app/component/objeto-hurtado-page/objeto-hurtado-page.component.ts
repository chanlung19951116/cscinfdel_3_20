...
@Component({
  selector: 'app-objeto-hurtado-page',
  templateUrl: './objeto-hurtado-page.component.html',
  styleUrls: ['./objeto-hurtado-page.component.scss']
})
export class ObjetoHurtadoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ObjetoHurtadoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ObjetoHurtadoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.objetoHurtado.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.objetoHurtado.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.objetoHurtado.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ObjetoHurtadoDataSource implements DataSource<any> {
