...
@Component({
  selector: 'app-tipo-discapacidad-page',
  templateUrl: './tipo-discapacidad-page.component.html',
  styleUrls: ['./tipo-discapacidad-page.component.scss']
})
export class TipoDiscapacidadPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoDiscapacidadDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoDiscapacidadDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoDiscapacidad.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoDiscapacidad.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoDiscapacidad.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoDiscapacidadDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.tipoDiscapacidad
      .getByPageAndFilter({
