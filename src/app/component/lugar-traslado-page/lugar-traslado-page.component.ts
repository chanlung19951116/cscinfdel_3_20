...
@Component({
  selector: 'app-lugar-traslado-page',
  templateUrl: './lugar-traslado-page.component.html',
  styleUrls: ['./lugar-traslado-page.component.scss']
})
export class LugarTrasladoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: LugarTrasladoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new LugarTrasladoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.lugarTraslado.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.lugarTraslado.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.lugarTraslado.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class LugarTrasladoDataSource implements DataSource<any> {
