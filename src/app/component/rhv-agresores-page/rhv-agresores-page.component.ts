...
@Component({
  selector: 'app-rhv-agresores-page',
  templateUrl: './rhv-agresores-page.component.html',
  styleUrls: ['./rhv-agresores-page.component.scss']
})
export class RhvAgresoresPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new SexoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.sexo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.sexo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.sexo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class SexoDataSource implements DataSource<any> {
