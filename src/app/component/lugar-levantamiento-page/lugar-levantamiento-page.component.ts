...
@Component({
  selector: 'app-lugar-levantamiento-page',
  templateUrl: './lugar-levantamiento-page.component.html',
  styleUrls: ['./lugar-levantamiento-page.component.scss']
})
export class LugarLevantamientoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: LugarLevantamientoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new LugarLevantamientoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.lugarLevantamiento.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.lugarLevantamiento.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.lugarLevantamiento.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class LugarLevantamientoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.lugarLevantamiento
      .getByPageAndFilter({
