...
@Component({
  selector: 'app-am-alcohol-agresor-page',
  templateUrl: './am-alcohol-agresor-page.component.html',
  styleUrls: ['./am-alcohol-agresor-page.component.scss']
})
export class AmAlcoholAgresorPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: AmAlcoholAgresorDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new AmAlcoholAgresorDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.amAlcoholAgresor.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.amAlcoholAgresor.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.amAlcoholAgresor.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class AmAlcoholAgresorDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.amAlcoholAgresor
      .getByPageAndFilter({
