...
@Component({
  selector: 'app-pd-condicion-regresa-desaparecido-page',
  templateUrl: './pd-condicion-regresa-desaparecido-page.component.html',
  styleUrls: ['./pd-condicion-regresa-desaparecido-page.component.scss']
})
export class PdCondicionRegresaDesaparecidoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: PdCondicionRegresaDesaparecidoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new PdCondicionRegresaDesaparecidoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.pdCondicionRegresaDesaparecido.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.pdCondicionRegresaDesaparecido.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.pdCondicionRegresaDesaparecido.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class PdCondicionRegresaDesaparecidoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.pdCondicionRegresaDesaparecido
      .getByPageAndFilter({
