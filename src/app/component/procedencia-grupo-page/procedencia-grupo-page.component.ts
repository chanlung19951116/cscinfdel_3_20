...
@Component({
  selector: 'app-procedencia-grupo-page',
  templateUrl: './procedencia-grupo-page.component.html',
  styleUrls: ['./procedencia-grupo-page.component.scss']
})
export class ProcedenciaGrupoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ProcedenciaGrupoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ProcedenciaGrupoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.procedenciaGrupo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.procedenciaGrupo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.procedenciaGrupo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ProcedenciaGrupoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.procedenciaGrupo
      .getByPageAndFilter({
