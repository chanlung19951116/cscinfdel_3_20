...
@Component({
  selector: 'app-modalidad-robo-page',
  templateUrl: './modalidad-robo-page.component.html',
  styleUrls: ['./modalidad-robo-page.component.scss']
})
export class ModalidadRoboPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ModalidadRoboDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ModalidadRoboDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.modalidadRobo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.modalidadRobo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.modalidadRobo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ModalidadRoboDataSource implements DataSource<any> {
