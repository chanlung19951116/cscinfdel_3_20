...
@Component({
  selector: 'app-causa-amenaza-page',
  templateUrl: './causa-amenaza-page.component.html',
  styleUrls: ['./causa-amenaza-page.component.scss']
})
export class CausaAmenazaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: CausaAmenazaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new CausaAmenazaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.causaAmenaza.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.causaAmenaza.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.causaAmenaza.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class CausaAmenazaDataSource implements DataSource<any> {
