...
@Component({
  selector: 'app-resto-victima-page',
  templateUrl: './resto-victima-page.component.html',
  styleUrls: ['./resto-victima-page.component.scss']
})
export class RestoVictimaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: RestoVictimaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new RestoVictimaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.restoVictima.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.restoVictima.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.restoVictima.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class RestoVictimaDataSource implements DataSource<any> {
