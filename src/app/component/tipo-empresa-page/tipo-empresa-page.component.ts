...
@Component({
  selector: 'app-tipo-empresa-page',
  templateUrl: './tipo-empresa-page.component.html',
  styleUrls: ['./tipo-empresa-page.component.scss']
})
export class TipoEmpresaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoEmpresaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoEmpresaDataSource(this.apiService, this.spinner);
  ...
  initForms() {
    ...
    this.createForm = this.fb.group({
      tipoEmpresaDescripcion: [null, Validators.compose([Validators.required])],
    });
  ...
  create() {
    ...
    this.apiService.tipoEmpresa.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  startEditing(row) {
    ...
    this.editForm.patchValue({
      tipoEmpresaDescripcion: row.tipoEmpresaDescripcion
    });
  ...
  save() {
    ...
    params.tipoEmpresaCodigo = this.selectedItem.tipoEmpresaCodigo;

    this.spinner.show();
    this.apiService.tipoEmpresa.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoEmpresa.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoEmpresaDataSource implements DataSource<any> {
