...
@Component({
  selector: 'app-lugar-donacion-page',
  templateUrl: './lugar-donacion-page.component.html',
  styleUrls: ['./lugar-donacion-page.component.scss']
})
export class LugarDonacionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: LugarDonacionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new LugarDonacionDataSource(this.apiService, this.spinner);
  ...
  initForms() {
    ...
    const controlsConfig = {
      ...
      contacto: [null, Validators.compose([Validators.required])],
    };
  ...
  create() {
    ...
    this.apiService.lugarDonacion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  startEditing(row) {
    ...
    this.editForm.patchValue({
      ...
      contacto: this.selectedItem.contacto,
    });
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.lugarDonacion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.lugarDonacion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class LugarDonacionDataSource implements DataSource<any> {
