...
@Component({
  selector: 'app-tipo-muerte-page',
  templateUrl: './tipo-muerte-page.component.html',
  styleUrls: ['./tipo-muerte-page.component.scss']
})
export class TipoMuertePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoMuerteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoMuerteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoMuerte.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoMuerte.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoMuerte.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoMuerteDataSource implements DataSource<any> {
