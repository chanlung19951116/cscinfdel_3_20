...
@Component({
  selector: 'app-instruccion-formal-page',
  templateUrl: './instruccion-formal-page.component.html',
  styleUrls: ['./instruccion-formal-page.component.scss']
})
export class InstruccionFormalPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: InstruccionFormalDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new InstruccionFormalDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.instruccionFormal.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.instruccionFormal.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.instruccionFormal.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class InstruccionFormalDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.instruccionFormal
      .getByPageAndFilter({
