...
@Component({
  selector: 'app-tipo-punto-page',
  templateUrl: './tipo-punto-page.component.html',
  styleUrls: ['./tipo-punto-page.component.scss']
})
export class TipoPuntoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: TipoPuntoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new TipoPuntoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.tipoPunto.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.tipoPunto.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.tipoPunto.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class TipoPuntoDataSource implements DataSource<any> {
