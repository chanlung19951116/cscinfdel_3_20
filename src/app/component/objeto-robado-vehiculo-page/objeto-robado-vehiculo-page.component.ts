...
@Component({
  selector: 'app-objeto-robado-vehiculo-page',
  templateUrl: './objeto-robado-vehiculo-page.component.html',
  styleUrls: ['./objeto-robado-vehiculo-page.component.scss']
})
export class ObjetoRobadoVehiculoPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ObjetoRobadoVehiculoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ObjetoRobadoVehiculoDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.objetoRobadoVehiculo.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.objetoRobadoVehiculo.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.objetoRobadoVehiculo.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ObjetoRobadoVehiculoDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.objetoRobadoVehiculo
      .getByPageAndFilter({
