...
export class MenuComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new MenuDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.menu.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.menu.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.menu.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class MenuDataSource implements DataSource<any> {
