...
export class ZonaPageComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.dataSource = new ZonaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.zona.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.zona.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.zona.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ZonaDataSource implements DataSource<any> {
