...
@Component({
  selector: 'app-condicion-calzada-page',
  templateUrl: './condicion-calzada-page.component.html',
  styleUrls: ['./condicion-calzada-page.component.scss']
})
export class CondicionCalzadaPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: CondicionCalzadaDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new CondicionCalzadaDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.condicionCalzada.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.condicionCalzada.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.condicionCalzada.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class CondicionCalzadaDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.condicionCalzada
      .getByPageAndFilter({
