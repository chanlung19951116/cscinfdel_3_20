...
@Component({
  selector: 'app-ocupacion-page',
  templateUrl: './ocupacion-page.component.html',
  styleUrls: ['./ocupacion-page.component.scss']
})
export class OcupacionPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: OcupacionDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new OcupacionDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.ocupacion.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.ocupacion.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.ocupacion.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class OcupacionDataSource implements DataSource<any> {
