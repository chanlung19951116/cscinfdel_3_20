...
@Component({
  selector: 'app-responsable-escaner-page',
  templateUrl: './responsable-escaner-page.component.html',
  styleUrls: ['./responsable-escaner-page.component.scss']
})
export class ResponsableEscanerPageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ResponsableEscanerDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ResponsableEscanerDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.responsableEscaner.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.responsableEscaner.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.responsableEscaner.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ResponsableEscanerDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.responsableEscaner
      .getByPageAndFilter({
