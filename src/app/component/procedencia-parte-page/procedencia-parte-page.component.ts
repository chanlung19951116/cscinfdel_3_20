...
@Component({
  selector: 'app-procedencia-parte-page',
  templateUrl: './procedencia-parte-page.component.html',
  styleUrls: ['./procedencia-parte-page.component.scss']
})
export class ProcedenciaPartePageComponent implements OnInit, AfterViewInit {
  ...
  dataSource: ProcedenciaParteDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ProcedenciaParteDataSource(this.apiService, this.spinner);
  ...
  create() {
    ...
    this.apiService.procedenciaParte.create(params).subscribe(() => {
        this.spinner.hide();
  ...
  save() {
    ...
    this.spinner.show();
    this.apiService.procedenciaParte.update(params).subscribe(() => {
        this.spinner.hide();
  ...
  onDeleteConfirmDialogYes() {
    ...
    this.apiService.procedenciaParte.delete(this.selectedItem).subscribe(
      () => {
        this.spinner.hide();
...
class ProcedenciaParteDataSource implements DataSource<any> {
  ...
  loadData(pageIndex, pageSize, filter = '', showSpinner = true) {
    ...
    this.apiService.procedenciaParte
      .getByPageAndFilter({
